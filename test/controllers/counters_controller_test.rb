...
class CountersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create counter" do
    assert_difference('Counter.count') do
      post counters_url, params: { counter: { flat_id: @counter.flat_id, type: @counter.type, value: @counter.value } }
    end
  ...
  test "should update counter" do
    patch counter_url(@counter), params: { counter: { flat_id: @counter.flat_id, type: @counter.type, value: @counter.value } }
